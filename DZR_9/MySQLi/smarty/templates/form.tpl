        ...
        <div class="col-xs-12 col-sm-8 col-md-10 col-md-offset-1 col-sm-offset-2">
            ...
            <form method="post" class="form-horizontal clearfix" enctype="multipart/form-data">
                ...
                <div class="email form-group col-md-12">
                    ...
                    <div class="col-sm-12">
                        <input placeholder="Введите адрес почты" type="email" class="form-control" id="field_email" value="{$new_ads.email}" name="email">
                    </div>
                </div>
                ...
                <div class="phone form-group col-md-12">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" placeholder="Введите номер телефона" id="field_phone" type="phone" value="{$new_ads.phone}" name="phone">
                    </div>
                </div>
                <div class="city form-group col-md-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        name=location options=$cities selected=$new_ads.location class="form-control"}
                    </div>
                </div>
                <div class="category form-group col-md-12">
                    ...
                    <div class="col-sm-12">
                         {html_options style="cursor:pointer; text-align-last: center;font-style:italic;"
                         name=category options=$categories selected=$new_ads.category class="form-control"}
                    </div>
                </div>
                <div class="title form-group col-md-12">
                    <label class="col-sm-3" for="title_field">Название</label>
                    <div class="col-sm-12">
                        <input class="form-control" placeholder="Введите название объявления" id="title_field" type="text" maxlength="50" value="{$new_ads.title}" name="title">
                    </div>
                </div>
                <div class="description form-group col-md-12">
                    ...
                    <div class="col-sm-12">
                        ...
                        maxlength="3000">{$new_ads.description}</textarea>
                    </div>
                </div>
