<?php /* Smarty version 2.6.30, created on 2016-12-04 21:21:20
                ...
                <div class="personal form-group col-md-12">
                    <div class="col-xs-12">
                        <label for="field_private">
                            <input type="radio" id="field_private"   <?php if ($this->_tpl_vars['new_ads']->get_private() == 1): ?>checked<?php endif; ?>
                                   value="1" checked="" name="private">Частное лицо
                        </label>
                    </div>
                    <div class="col-xs-12">
                        <label for="field_company">
                            <input type="radio" id="field_company" <?php if ($this->_tpl_vars['new_ads']->get_private() == 2): ?>checked<?php endif; ?>
