<?php /* Smarty version 2.6.30, created on 2016-12-29 11:08:51
...
<div class="container">
    <div class="row row-main">
        <div class="col-xs-12 col-sm-8 col-md-10 col-md-offset-1 col-sm-offset-2">
            ...
            <font size="3">
            <form method="post" class="form-horizontal clearfix"  id="form">
...
" 
        ...
        <input type="radio" <?php if ($this->_tpl_vars['new_ads']->get_private() == 1): ?>checked=""<?php endif; ?>value="1" name="private" id="field_company">Компания</label>
                ...
                <div class="form-group col-sm-12">
                    ...
                    <button type="button" class="btn btn-info btn_clear_photos" name="clear_photos">Удалить фотографии</button>
                </div>
                    <input class="hidden_id" type="hidden" name="id" value="<?php echo $this->_tpl_vars['new_ads']->get_id(); ?>
">
                </form>
                 <div class="col-md-12">
                    <form method="post" class="form-horizontal clearfix"  id="form_img" enctype="multipart/form-data">
                    <input id="input-file" type="file" data-filename-placement="inside" name="fupload">
