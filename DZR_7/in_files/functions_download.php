...
if (!empty($images)) {
    foreach ($images as $key => $image) {
        echo '<a target="_blank" href="img_big/' . $image . '"><img src="img_small/' . $image . '" alt="picture"></a>';
    }
} else {
    echo '<h3 style="color:purple;">Загруженных файлов не найдено</h5>';
}
}

function clear_dirs($mass) {
